...
mymodel ="Quarter+s(Year,Quarter,bs='re') + Gear + te(ctime,utm.x,utm.y,d=c(1,2),bs=c('cs','ts'),k=c(12,36),by=Quarter) + DepthRS:Quarter + I(DepthRS^2):Quarter  +s(TimeShotHour,k=6,bs='cc')+offset(log(HaulDur))"
